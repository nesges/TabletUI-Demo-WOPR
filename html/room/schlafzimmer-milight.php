...
<div class="container">
    ...
    <div class="centered" style="margin-top:20px !important">
        <div id="orange" data-type="button" data-fhem-cmd="set+MILIGHT_Zone2_Schlafzimmer+hue+50" data-icon="fa-paint-brush" data-color="hsl(50,100%,50%)" class="cell"></div>
        <div id="green" data-type="button" data-fhem-cmd="set+MILIGHT_Zone2_Schlafzimmer+hue+130" data-icon="fa-paint-brush" data-color="hsl(130,100%,50%)" class="cell"></div>
        <div id="lblue" data-type="button" data-fhem-cmd="set+MILIGHT_Zone2_Schlafzimmer+hue+190" data-icon="fa-paint-brush" data-color="hsl(190,100%,50%)" class="cell"></div>
        <div id="blue" data-type="button" data-fhem-cmd="set+MILIGHT_Zone2_Schlafzimmer+hue+240" data-icon="fa-paint-brush" data-color="hsl(240,100%,50%)" class="cell"></div>
        <div id="pink" data-type="button" data-fhem-cmd="set+MILIGHT_Zone2_Schlafzimmer+hue+320" data-icon="fa-paint-brush" data-color="hsl(320,100%,50%)" class="cell"></div>
        <div id="red" data-type="button" data-fhem-cmd="set+MILIGHT_Zone2_Schlafzimmer+hue+360" data-icon="fa-paint-brush" data-color="hsl(360,100%,50%)" class="cell"></div>
    </div>
</div>
    </li>
    ...
    <div class="left">
        <div data-type="switch" data-device="S_SWITCH_C2_Sterne" class="cell"></div>
                ...
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_C2_Sterne" class="cell" data-set="on-for-timer 300"></div>
                <div data-type="label" class="cell">5 Minuten</div>
            </div>
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_C2_Sterne" class="cell" data-set="on-for-timer 900"></div>
                ...
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_C2_Sterne" class="cell" data-set="on-for-timer 7200"></div>
    ...
    <div class="left">
        <div data-type="switch" data-device="S_SWITCH_B2_Leselampe" class="cell"></div>
                ...
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_B2_Leselampe" class="cell" data-set="on-for-timer 300"></div>
                <div data-type="label" class="cell">5 Minuten</div>
            </div>
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_B2_Leselampe" class="cell" data-set="on-for-timer 900"></div>
                <div data-type="label" class="cell">15 Minuten</div>
            </div>
                <div class="left">
                ...
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_B2_Leselampe" class="cell" data-set="on-for-timer 7200"></div>
                <div data-type="label" class="cell">2 Stunden</div>
            </div>
    </div>
    </li>
    <li data-row="3" data-col="4" data-sizex="4" data-sizey="1">
        ...
        <div class="centered container">
    <div class="left">
        <div data-type="switch" data-device="S_SWITCH_A2_TV" class="cell"></div>
    </div>
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_A2_TV" class="cell" data-set="on-for-timer 1800"></div>
                <div data-type="label" class="cell">30 Minuten</div>
            </div>
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_A2_TV" class="cell" data-set="on-for-timer 3600"></div>
                <div data-type="label" class="cell">1 Stunde</div>
            </div>
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_A2_TV" class="cell" data-set="on-for-timer 7200"></div>
                <div data-type="label" class="cell">2 Stunden</div>
            </div>
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_A2_TV" class="cell" data-set="on-for-timer 14400"></div>
                <div data-type="label" class="cell">4 Stunden</div>
            </div>
                <div class="left">
                <div data-type="push" data-device="S_SWITCH_A2_TV" class="cell" data-set="on-for-timer 0"></div>
                <div data-type="label" class="cell"><span style='font-size:140%'>&infin;</span></div>
            </div>
    </div>
    </li>
