...
<div class="container">
    ...
    <li data-row="1" data-col="2" data-sizex="5" data-sizey="3">
        <iframe src="../../plots/index.html?p=P_SCHLAFZIMMER&amp;nonav&amp;dark&amp;nolegend" width='680' height='410' scrolling='no' allowtransparency='true' frameborder='0'></iframe>
    </li>
    ...
    <li data-row="3" data-col="7" data-sizex="1" data-sizey="1">
        ...
        <div id="wecker" data-type="button" data-url="schlafzimmer-wecker.php" data-icon="fa-clock-o" data-color="rgb(111,69,0)" class="cell"></div>
