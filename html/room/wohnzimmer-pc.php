...
<li data-row="1" data-col="2" data-sizex="6" data-sizey="2">
	...
	<div class="centered container">
	    <div class="left">
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Start%22%29%7D" data-icon="fa-play-circle" data-color="rgb(111,69,0)" class="cell"></div>
            <div data-type="label">Ein</div>
        </div>
        <div class="left">
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Exit%22%29%7D" data-icon="fa-power-off" data-color="rgb(111,69,0)" class="cell"></div>
	        <div data-type="label">Aus</div>
	    </div>
	    <div class="left">
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Playlist+Rockantenne%22%29%7D" data-icon="fa-music" data-color="#2E8AE6" class="cell"></div>
	        <div data-type="label">Rockantenne</div>
        </div>
        <div class="left">
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Playlist+Beggelfest13%22%29%7D" data-icon="fa-music" data-color="#2E8AE6" class="cell"></div>
	        <div data-type="label">BF13</div>
        </div>
        <div class="left">
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Playlist+Tormentedradio%22%29%7D" data-icon="fa-music" data-color="#2E8AE6" class="cell"></div>
	        <div data-type="label">tormented</div>
        </div>
        <div class="left">
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Playlist+DLF%22%29%7D" data-icon="fa-music" data-color="#2E8AE6" class="cell"></div>
	        <div data-type="label">DLF</div>
        </div>
        <div class="left">
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Playlist+DKultur%22%29%7D" data-icon="fa-music" data-color="#2E8AE6" class="cell"></div>
	        <div data-type="label">DKultur</div>
        </div>
        <div class="left">
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Playlist+DWissen%22%29%7D" data-icon="fa-music" data-color="#2E8AE6" class="cell"></div>
	        <div data-type="label">DWissen</div>
        </div>
    </div>
    <div class="centered container" style="margin-top:40px !important">
	    <div class="left">
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Play+Toggle%22%29%7D" data-icon="fa-play" data-color="#FFCC00" class="cell"></div>
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Pause%22%29%7D" data-icon="fa-pause" data-color="rgb(170,105,0)" class="cell"></div>
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Stop%22%29%7D" data-icon="fa-stop" data-color="rgb(170,105,0)" class="cell"></div>
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Previous%22%29%7D" data-icon="fa-step-backward" data-color="rgb(111,69,0)" class="cell"></div>
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Next%22%29%7D" data-icon="fa-step-forward" data-color="rgb(111,69,0)" class="cell"></div>
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Volume+Down%22%29%7D" data-icon="fa-volume-down" data-color="rgb(111,69,0)" class="cell"></div>
	        <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22Winamp+Volume+Up%22%29%7D" data-icon="fa-volume-up" data-color="rgb(111,69,0)" class="cell"></div>
	    </div>
    </div>
</li>
	    ...
	    <div class="left">
            <div data-type="circlemenu" class="cell circlemenu">
                <ul class="menu">
                    ...
                    <li><div data-type="push" data-cmd="{eventghost('WATER', 'KODI Start')}" data-icon="fa-play-circle" data-off-background-color="#aa6900"></div></li>
                    <li><div data-type="push" data-cmd="{eventghost('WATER', 'KODI Focus')}" data-icon="fa-bullseye" data-off-background-color="#aa6900"></div></li>
                    <li><div data-type="push" data-cmd="{eventghost('WATER', 'KODI Exit')}" data-icon="fa-power-off" data-off-background-color="#aa6900"></div></li>
                </ul>
            </div>
        </div>
	    <div class="left">
            ...
            <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22KODI+Info%22%29%7D" data-icon="fa-info" data-color="rgb(111,69,0)" class="cell"></div>
            <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22KODI+Back%22%29%7D" data-icon="fa-arrow-circle-o-left" data-color="rgb(111,69,0)" class="cell"></div>
            <div id="" data-type="button" data-fhem-cmd="%7Beventghost%28%22WATER%22%2C+%22KODI+Fullscreen%22%29%7D" data-icon="fa-desktop" data-color="rgb(111,69,0)" class="cell"></div>
        </div>
    </div>

	<div style="display:none" id="xbmc_playstatus"    data-type="label" data-device="W_XBMC" data-get="playStatus" data-fix=0></div>
	<div style="display:none" id="xbmc_show"    data-type="label" data-device="W_XBMC" data-get="currentShowtitle" data-fix=0></div>
	<div style="display:none" id="xbmc_season"  data-type="label" data-device="W_XBMC" data-get="season" data-fix=0></div>
	<div style="display:none" id="xbmc_episode" data-type="label" data-device="W_XBMC" data-get="episode" data-fix=0></div>
	<div style="display:none" id="xbmc_title"   data-type="label" data-device="W_XBMC" data-get="currentTitle" data-fix=0></div>
	<div style="display:none" id="xbmc_artist"  data-type="label" data-device="W_XBMC" data-get="currentArtist" data-fix=0></div>
	<div style="display:none" id="xbmc_album"   data-type="label" data-device="W_XBMC" data-get="currentAlbum" data-fix=0></div>
    <div class="centered container">
	    ...
	    <div class="left">
            <div data-type="circlemenu" class="cell circlemenu">
                <ul class="menu">
                    ...
                    <li><div data-type="push" data-cmd="{eventghost('WATER', 'PC Mute Toggle')}" data-icon="fa-volume-off" data-off-background-color="#aa6900"></div></li>
                    <li><div data-type="push" data-cmd="{eventghost('WATER', 'PC Volume Up')}" data-icon="fa-volume-up" data-off-background-color="#aa6900"></div></li>
                    <li><div data-type="push" data-cmd="{eventghost('WATER', 'PC Volume Down')}" data-icon="fa-volume-down" data-off-background-color="#aa6900"></div></li>
                </ul>
            </div>
        ...
        <div class="left">
            <div data-type="circlemenu" class="cell circlemenu">
                <ul class="menu">
                    ...
                    <li><div data-type="push" data-cmd="{eventghost('WATER', 'PC Shutdown')}" data-icon="fa-power-off" data-off-background-color="#aa6900"></div></li>
                    <li><div data-type="push" data-cmd="{eventghost('WATER', 'PC Hibernate')}" data-icon="fa-pause" data-off-background-color="#aa6900"></div></li>
                    <li><div data-type="push" data-cmd="{eventghost('WATER', 'PC Restart')}" data-icon="fa-repeat" data-off-background-color="#aa6900"></div></li>
                </ul>
            </div>
